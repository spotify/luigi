...
class scheduler(Config):
    ...
    # TODO(erikbern): the config_path is needed for backwards compatilibity, should throw a deprecation
    # error and parse from the "right" config instead (need to fix this in luigi.parameter)

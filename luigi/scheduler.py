    ...
    def load(self):
        if os.path.exists(self._state_path):
            ...
            try:
                ...
                logger.exception("Error when loading state. Starting from clean state.")
                return
            ...
            logger.info("No prior state file exists at %s. Starting with clean state", self._state_path)

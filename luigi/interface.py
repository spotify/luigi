...
def run(cmdline_args=None, existing_optparse=None, use_optparse=None, main_task_cls=None,
        worker_scheduler_factory=None, use_dynamic_argparse=False, local_scheduler=False):
    """
    Run from cmdline using argparse.

    :param cmdline_args:
    :param existing_optparse: DEPRECATED, just ignored
    :param use_optparse: DEPRECATED, just ignored
    :param main_task_cls:
    :param worker_scheduler_factory:
    :param use_dynamic_argparse:
    :param local_scheduler:
    """
    if use_optparse is not None:
        warnings.warn("Ignoring deprecated 'use_optparse' setting")

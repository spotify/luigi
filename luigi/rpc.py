...
class RemoteScheduler(Scheduler):
    ...
    def add_task(self, worker, task_id, status=PENDING, runnable=False, deps=None, expl=None, new_deps=[]):
...
class RemoteSchedulerResponder(object):
    ...
    def add_task(self, worker, task_id, status, runnable, deps, expl, new_deps, **kwargs):
        return self._scheduler.add_task(worker, task_id, status, runnable, deps, expl, new_deps)

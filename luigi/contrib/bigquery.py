...
class BigqueryTarget(luigi.target.Target):
    def __init__(self, project_id, dataset_id, table_id, client=None, tmp_dataset_id=None):
        ...
        tmp_table_id = "_" + table_id + "_%09" % random.randrange(0, 1e10)
        self.tmp_table = BQTable(project=project_id, dataset=tmp_dataset_id or "_incoming", table_id=tmp_table_id)

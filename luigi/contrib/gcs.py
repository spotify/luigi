...
# The following import is needed for python3, but since we're on python2.7 we're fine
# see discussion here https://github.com/mortardata/luigi/pull/42#discussion_r172782250

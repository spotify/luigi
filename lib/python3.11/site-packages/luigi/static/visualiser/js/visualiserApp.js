function visualiserApp(luigi) {
    ...
    function minMaxWindow(button) {
        console.log("FROM MIN MAX");

        const icon = $(button).find(".icon");

        // Check current state
        const isExpanded = icon.hasClass("fa-minus");

        if (isExpanded) {
          $(".modal-dialog").removeClass("expanded");
          icon.removeClass("fa-minus").addClass("fa-plus");
        } else {
          $(".modal-dialog").addClass("expanded");
   ...
   function expandedResources() {
    ...
    $(document).ready(function() {
        ...
        $('#errorModal').on('click', '#expandModal', function () {
